...
const HomePage = ({ lang, siteSettings, menuItems, handleOpenItemDetails, cart, setCart }) => {
  ...
  return (
    <div className="bg-[#050505] text-white overflow-hidden">
      {/* HERO — نفس تكوين الريفرنس: نص ضخم يسار + برجر يمين */}
      <section className="relative min-h-[720px] md:min-h-[calc(100vh-78px)] flex items-stretch overflow-hidden border-b border-[#8d1710]">
        ...
        <div className="relative z-10 w-full max-w-[1500px] mx-auto px-6 md:px-12 flex items-center">
          <div className="w-full md:w-[48%] py-24 md:py-20">
            ...
            <p className="mt-8 text-white/90 text-lg md:text-xl font-bold max-w-md leading-relaxed">
              {lang === 'ar'
            ...
            <Link
              to="/menu"
              className="inline-flex items-center gap-5 mt-8 bg-[#ed321c] hover:bg-[#ff4528] text-white px-8 md:px-10 py-4 font-black text-base md:text-lg transition-all duration-300 shadow-[0_12px_40px_rgba(237,50,28,.28)]"
          ...
          <div className="hidden md:block absolute right-8 top-24 text-right">
            <div className="text-[#ef321b] italic text-3xl lg:text-5xl leading-none" style={{fontFamily:'cursive'}}>
              Real Chicken<br />Real Taste
            </div>
          </div>

          <div className="absolute bottom-10 right-8 md:right-14 flex gap-3">
      ...
      {/* MENU PREVIEW — نفس توزيع الريفرنس */}
...
// ================= 2. صفحة المنيو — نفس هوية الريفرنس =================
    ...
    <section className="bg-[#050505] text-white min-h-screen overflow-hidden">
      <div className="max-w-[1500px] mx-auto px-5 md:px-10 pt-14 pb-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-5 border-b border-white/10 pb-8">
          ...
          <div className="text-right text-[#ef321b] italic font-black text-2xl">BIGGER<br/>JUICIER<br/>HOTTER</div>
        </div>
                          ...
                          <button onClick={open} className="w-full text-left">
                            ...
                            <div className="p-5">
                              ...
                              <div className="flex items-center justify-between mt-6">
                                <span className="text-[#ef321b] text-2xl font-black">EGP {price}</span>
                                <span className="w-9 h-9 border border-white/15 flex items-center justify-center text-xl group-hover:bg-[#ef321b] group-hover:border-[#ef321b] transition">+</span>
                              </div>
                            </div>
                          </button>
